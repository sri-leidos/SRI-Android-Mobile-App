...
//            e.printStackTrace();
    ...
    public void determineGeoFence(double _lat, double _lon) {
        ...
        isInsideFence = true; //coordinateChecker.isGpsContained(_lat, _lon);
...
//                WebServicePoster.postToWebService(getApplicationContext(), _lat, _lon, 1);
    ...
    private class GPSServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            gps.getLocationManager().requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 10 * 1000, 0, GeoFenceActivity.this);
            gps.getLocationManager().requestLocationUpdates(LocationManager.GPS_PROVIDER, 10 * 1000, 0, GeoFenceActivity.this);
